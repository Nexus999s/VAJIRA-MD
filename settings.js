...
const FOOTERNAME = '> NEXUS -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '919945489885'
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=rF1UXLSK#_mQAdHYRPwF8-0ERKW4j6AoRGgwvY75jh2pD8iZE9kM' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "919945489885" : process.env.MODERATORS ,    
